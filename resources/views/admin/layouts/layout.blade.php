  ...
  <body class="hold-transition skin-blue sidebar-mini" style="direction:rtl">
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu">
                  <li class="header" style="text-align:center; "><a href="{{ url('/adminpanel/contact') }}">كل الرسائل</a> </li>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div style="text-align:center;">
                      <a href="{{ url('/') }}" class="btn btn-default btn-flat" >الرئيسية </a>
                    </div>
                  </li>
                </ul>
              </li>
     ...
     <div class="content-wrapper">
      ...
      <h6 style="text-align:center;"><strong>Copyright &copy; Anas Fathy Salama </strong> </h6> 
    </footer> 
